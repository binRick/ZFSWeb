...
module.exports.query = function(ip, cb) {
    request('http://127.0.0.1:4000/lua/host_get_json.lua?ifname=0&host=' + ip, function(e, response, body) {
        if (e) throw e;
        //console.log(body);
        //cb(e, null);
        try {
        ...
        R.Throughput_trend_bps = J.throughput_trend_bps;
        R.Throughput_bps = J.throughput_bps;
